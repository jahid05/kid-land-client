      ...
      <div className="container mx-auto navbar">
        ...
        {user?.uid ? (
          <div className="navbar-end">
            ...
            <button
              className="btn  rounded-full ms-2 normal-case font-custom-100 bg-theme-100 border-none"
          ...
          <div className="navbar-end">
            <Link to="/login">
              <button className="btn rounded-full md:px-9 normal-case font-custom-100 bg-theme-100 border-none">
                Sign in
              </button>
            </Link>
          </div>
